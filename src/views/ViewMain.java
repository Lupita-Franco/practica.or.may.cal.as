...
public class ViewMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jmi_mayor.setText("Mayor de 3 Numeros");
        jmi_mayor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jmi_mayorActionPerformed(evt);
            }
        });
        jMenu3.add(jmi_mayor);

        jmi_operaciones.setText("Operaciones");
        jMenu3.add(jmi_operaciones);

        jmi_ordenar.setText("Ordenar Ascendente y Promedio");
        jMenu3.add(jmi_ordenar);
